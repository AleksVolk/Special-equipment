(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".about-slider__body")) new core(".about-slider__body", {
                ...
                navigation: {
                    prevEl: ".about-slider__arrows .slider-arrow_prev",
                    nextEl: ".about-slider__arrows .slider-arrow_next"
                },
                breakpoints: {
                    320: {
                        spaceBetween: 15
            ...
            if (document.querySelector(".projects-slider__body")) new core(".projects-slider__body", {
                modules: [ Navigation, Pagination ],
                slidesPerView: 1.5,
                speed: 800,
                spaceBetween: 16,
                pagination: {
                    el: ".projects__paginarion",
                    clickable: true
                },
                navigation: {
                    prevEl: ".projects-slider__arrows .slider-arrow_prev",
                    nextEl: ".projects-slider__arrows .slider-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.5
